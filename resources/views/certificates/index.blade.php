    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">
                Total: {{ $certificates->count() }} sertifikat
            </div>
        </div>
    </x-slot>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                                <div class="space-y-2">
                                                    <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                                                        ...
                                                        <span class="ml-2">{{ $certificate->issued_at->format('d F Y') }}</span>
                                                    </div>
                                                    ...
                                                    <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                                                        ...
                                                        <span class="ml-2 font-mono text-xs bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">{{ $certificate->certificate_code }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="space-y-2">
                                                    @if($certificate->course->instructors->first())
                                                        <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                                                            ...
                                                            <span class="ml-2">{{ $certificate->course->instructors->first()->name }}</span>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                                                        ...
                                                        <span class="ml-2">{{ $certificate->certificateTemplate->name ?? 'Default' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
