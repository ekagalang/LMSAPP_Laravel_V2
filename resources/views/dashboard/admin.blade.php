                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                {{-- 🚨 PERBAIKAN: Ganti .total() dengan .count() --}}
                                <p class="text-2xl font-semibold text-gray-900 stat-number">{{ number_format($announcements->count()) }}</p>
                            </div>
                        </div>
                        <div class="mt-4">
                            <div class="text-xs text-gray-600">
                                {{-- 🚨 PERBAIKAN: Pastikan menggunakan stats yang benar --}}
                                {{ $stats['announcements']['active'] ?? 0 }} aktif dari {{ $stats['announcements']['total'] ?? 0 }} total
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-center p-4 bg-gray-50 rounded-lg hover-lift">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-xs text-gray-600">oleh {{ $course->instructors->pluck('name')->join(', ') }}</p>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div class="p-6 space-y-3">
                            ...
                            <a href="{{ route('assignments.index') }}" class="flex items-center w-full px-4 py-3 text-left text-sm font-medium text-gray-700 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors hover-lift group">
                                <svg class="w-5 h-5 mr-3 text-gray-400 group-hover:text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                                </svg>
                                Kelola Tugas
                            ...
                            <a href="{{ route('admin.announcements.index') }}" class="flex items-center w-full px-4 py-3 text-left text-sm font-medium text-gray-700 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors hover-lift group">
                                <svg class="w-5 h-5 mr-3 text-gray-400 group-hover:text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"></path>
                                </svg>
                                Kelola Pengumuman
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-sm font-medium text-gray-900">{{ number_format($stats['users']['participants']) }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600">Total Instruktur</span>
                                    <span class="text-sm font-medium text-gray-900">{{ number_format($stats['users']['instructors']) }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600">Kursus Published</span>
                                    <span class="text-sm font-medium text-gray-900">{{ number_format($stats['courses']['published']) }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-600">Diskusi Aktif</span>
                                    <span class="text-sm font-medium text-gray-900">{{ number_format($stats['discussions']['total']) }}</span>
                                </div>
                                <div class="pt-4 border-t border-gray-200">
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm font-medium text-gray-900">Total Aktivitas</span>
                                        <span class="text-lg font-bold text-indigo-600">{{ number_format($stats['quizzes']['attempts'] + $stats['essays']['submissions'] + $stats['discussions']['total']) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
