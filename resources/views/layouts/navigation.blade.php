{{-- 
    CATATAN: Jika menu admin masih tidak muncul setelah memperbarui file ini,
    coba jalankan perintah 'php artisan view:clear' di terminal Anda
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <!-- Menu khusus Super Admin menjadi dropdown -->
                    @role('super-admin')
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('view progress reports')
                 <x-responsive-nav-link :href="route('eo.courses.index')" :active="request()->routeIs('eo.courses.index')">
                    {{ __('Pemantauan Kursus') }}
                </x-responsive-nav-link>
            @endcan
            ...
            @role('super-admin')
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="px-4">
                        <div class="font-medium text-base text-gray-800">Manajemen Admin</div>
                    </div>
