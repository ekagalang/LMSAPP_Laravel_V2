                    ...
                    <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-green-900">{{ $submissions->where('graded_at', '!=', null)->count() }}</p>
                            </div>
                    ...
                    <div class="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-6 border border-orange-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-orange-900">{{ $submissions->where('graded_at', null)->count() }}</p>
                            </div>
