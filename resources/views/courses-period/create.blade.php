        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center">
                    <div class="flex items-center text-indigo-600">
                        ...
                        <span class="ml-2 text-sm font-medium">Detail Periode</span>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl">
                ...
                <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-4">
                    <h3 class="text-lg font-semibold text-white">Buat Periode Kursus</h3>
                    <p class="text-indigo-100 text-sm mt-1">Tentukan detail periode untuk batch/angkatan baru</p>
                </div>
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <p class="text-sm text-gray-600">{{ $course->description ? Str::limit($course->description, 100) : 'Membuat periode baru untuk kursus ini' }}</p>
                                </div>
                                <div class="flex-shrink-0">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="group">
                                    ...
                                    <textarea name="description"
                                              ...
                                              placeholder="Deskripsi khusus untuk periode ini (opsional)...">{{ old('description') }}</textarea>
