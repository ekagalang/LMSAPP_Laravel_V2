<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Tambah Video Interaction - {{ $content->title }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <form action="{{ route('admin.video-interactions.store', $content) }}" method="POST" x-data="interactionForm()">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <select name="type" id="type" x-model="type" required 
                                    ...
                                    <option value="quiz">🧠 Quiz - Pertanyaan interaktif</option>
                                    <option value="reflection">🤔 Reflection - Refleksi pembelajaran</option>
                                    <option value="annotation">📝 Annotation - Catatan penting</option>
                                    <option value="hotspot">📍 Hotspot - Area yang bisa diklik</option>
                                    <option value="overlay">🎯 Overlay - Informasi overlay</option>
                                    <option value="pause">⏸️ Pause - Titik jeda</option>
                                </select>
                                @error('type')
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="3" 
                                      class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Deskripsi atau pertanyaan..."></textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        <label class="flex items-center">
                                            <input type="radio" name="reflection_type" value="text" checked
                                ...
                                <div>
                                    ...
                                    <textarea name="reflection_question" id="reflection_question" rows="3" 
                                              ...
                                              placeholder="Contoh: Bagaimana Anda akan menerapkan konsep ini di pekerjaan Anda?"></textarea>
                                </div>
                                        ...
                                        <div class="space-y-2">
                                            <div class="flex items-center space-x-2">
                                                <input type="radio" name="reflection_correct_answer" value="0" 
                                                       class="text-purple-600 focus:ring-purple-500">
                                                <input type="text" name="reflection_options[0][text]"
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <input type="radio" name="reflection_correct_answer" value="1" 
                                                       class="text-purple-600 focus:ring-purple-500">
                                                <input type="text" name="reflection_options[1][text]"
                                                       class="flex-1 border-gray-300 rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500"
                                                       placeholder="Pilihan 2">
                                            </div>
                                            <div class="flex items-center space-x-2">
                                                <input type="radio" name="reflection_correct_answer" value="2" 
                                                       class="text-purple-600 focus:ring-purple-500">
                                                <input type="text" name="reflection_options[2][text]"
                                                       class="flex-1 border-gray-300 rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500"
                                                       placeholder="Pilihan 3">
                                            </div>
                                            <div class="flex items-center space-x-2">
                                                <input type="radio" name="reflection_correct_answer" value="3" 
                                                       class="text-purple-600 focus:ring-purple-500">
                                                <input type="text" name="reflection_options[3][text]"
                                                       class="flex-1 border-gray-300 rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500"
                                                       placeholder="Pilihan 4">
                                            </div>
                                        </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="reflection_is_required"
                                    ...
                                    <div>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="reflection_has_scoring"
                                                   class="rounded border-gray-300 text-purple-600 shadow-sm focus:border-purple-300 focus:ring focus:ring-purple-200 focus:ring-opacity-50">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <textarea name="overlay_content" id="overlay_content" rows="3" 
                                              class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                              placeholder="Konten yang akan ditampilkan di overlay..."></textarea>
                                </div>
                                <div>
                                    <label for="duration" class="block text-sm font-medium text-gray-700 mb-2">Durasi (detik)</label>
                                    <input type="number" name="duration" id="duration" min="1" max="60" value="5"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                           placeholder="5">
                        ...
                        <div x-show="type === 'annotation'" class="mb-6 p-4 bg-yellow-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <textarea name="annotation_text" id="annotation_text" rows="3" 
                                          class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                          placeholder="Catatan atau penjelasan tambahan..."></textarea>
