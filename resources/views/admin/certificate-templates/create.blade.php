<x-app-layout>
                        ...
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Provide a name and background for your template.</p>
                                </div>
                            ...
                            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <x-input-label for="background_image" :value="__('Background Image (JPG, PNG)')" />
                                    <input @change="handleBackgroundUpload" id="background_image" class="block mt-1 w-full" type="file" name="background_image" required>
    ...
    function certificateEditor() {
        return {
            ...
            submitForm() {
                // Data sudah terikat dengan x-model, jadi kita bisa langsung submit
