<x-app-layout>
                ...
                <form id="template-form" @submit.prevent="submitForm" method="POST" action="{{ route('admin.certificate-templates.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            {{-- Container tersembunyi untuk semua input file --}}
                            <div class="hidden">
                    ...
                    <div class="mt-8 flex flex-col lg:flex-row gap-8">
                        ...
                        <div class="lg:w-1/4 space-y-8">
                            ...
                            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                                ...
                                <p class="text-sm text-gray-500 mb-4">Click an element to add it to the active page.</p>
                                <div class="space-y-3">
    ...
    function certificateEditor() {
        return {
            ...
            getSanitizedPages() {
                return this.pages.map(page => ({ elements: page.elements }));
            },
