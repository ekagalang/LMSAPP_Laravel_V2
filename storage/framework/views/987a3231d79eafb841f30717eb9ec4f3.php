                                ...
                                <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl border border-gray-100 overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:border-indigo-200">
                                    ...
                                    <div class="relative overflow-hidden">
                                        ...
                                        <div class="absolute top-4 right-4">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider shadow-lg
                                                <?php echo e($course->status === 'published' 
                                    ...
                                    <div class="p-6">
                                        ...
                                        <div class="flex items-center mb-6 p-3 bg-gray-50 rounded-xl">
                                            ...
                                            <div class="ml-3 flex-1 min-w-0">
                                                ...
                                                <p class="text-sm font-semibold text-gray-900 truncate">
                                                    <?php echo e($course->instructors->pluck('name')->join(', ') ?: 'Belum ditentukan'); ?>
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <!-- Duplicate Button -->
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('duplicate', App\Models\Course::class)): ?>
                                                <form action="<?php echo e(route('courses.duplicate', $course)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Anda yakin ingin menduplikasi kursus ini?');">
                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $course)): ?>
                                                <form action="<?php echo e(route('courses.destroy', $course)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kursus ini? Tindakan ini tidak dapat dibatalkan.');">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\PC2\Videos\IT\Code\LMSCOK\ABC\Cok\LMSAPP_Laravel_V2\resources\views/courses/index.blade.php ENDPATH**/ ?>