     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1"><?php echo e($course->title); ?></p>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl mb-6" x-data="{
                ...
                courseTokenValue: '<?php echo e($course->enrollment_token ?? ''); ?>'
            }">
                ...
                <div class="p-6">
                    <?php if($course->enrollment_token): ?>
                        <div class="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-lg p-6 border-2 border-purple-200">
                            ...
                            <?php if($course->token_expires_at): ?>
                                <p class="text-sm text-gray-600 mb-4">
                                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    Kadaluarsa: <strong><?php echo e($course->token_expires_at->format('d M Y H:i')); ?></strong>
                                    <?php if($course->token_expires_at->isPast()): ?>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <form action="<?php echo e(route('courses.token.toggle', $course)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
                                            class="w-full px-4 py-3 <?php echo e($course->token_enabled ? 'bg-gray-600 hover:bg-gray-700' : 'bg-green-600 hover:bg-green-700'); ?> text-white font-medium rounded-lg transition-colors shadow-sm">
                                        <?php if($course->token_enabled): ?>
                                            <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <?php $__currentLoopData = $course->classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-lg p-5 border-2 border-indigo-200"
                                     x-data="{
                                         showToken: false,
                                         tokenValue: '<?php echo e($class->enrollment_token ?? ''); ?>'
                                     }">
                                    <div class="flex items-start justify-between mb-4">
                                        <div class="flex-1">
                                            <h4 class="font-semibold text-gray-900 mb-1"><?php echo e($class->name); ?></h4>
                                            <?php if($class->start_date && $class->end_date): ?>
                                                <p class="text-xs text-gray-500">
                                                    <?php echo e($class->start_date->format('d M Y')); ?> - <?php echo e($class->end_date->format('d M Y')); ?>
                                            ...
                                            <?php if($class->max_participants): ?>
                                                <p class="text-xs text-gray-500">
                                                    <?php echo e($class->participants->count()); ?>/<?php echo e($class->max_participants); ?> peserta
                                                </p>
                                            <?php endif; ?>
                                        </div>
                                        <span class="px-2 py-1 rounded-full text-xs font-medium
                                            <?php if($class->status === 'active'): ?> bg-green-100 text-green-800
                                            <?php elseif($class->status === 'upcoming'): ?> bg-blue-100 text-blue-800
                                            <?php elseif($class->status === 'completed'): ?> bg-gray-100 text-gray-800
                                    ...
                                    <?php if($class->enrollment_token): ?>
                                        ...
                                        <div class="grid grid-cols-2 gap-2">
                                            <button type="button"
                                                    @click="$dispatch('open-modal', 'regenerate-class-token-<?php echo e($class->id); ?>')"
                                                    class="w-full px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium rounded transition-colors">
                                                🔄 Regenerate
                                            </button>
                                            <form action="<?php echo e(route('course-periods.token.toggle', [$course, $class])); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit"
                                                        class="w-full px-3 py-2 <?php echo e($class->token_enabled ? 'bg-gray-600 hover:bg-gray-700' : 'bg-green-600 hover:bg-green-700'); ?> text-white text-xs font-medium rounded transition-colors">
                                                    <?php echo e($class->token_enabled ? '🚫 Disable' : '✓ Enable'); ?>
                                    ...
                                    <?php else: ?>
                                        <button type="button"
                                                @click="$dispatch('open-modal', 'generate-class-token-<?php echo e($class->id); ?>')"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'generate-course-token','show' => false,'maxWidth' => '2xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'generate-course-token','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => '2xl']); ?>
        <form action="<?php echo e(route('courses.token.generate', $course)); ?>" method="POST" class="p-6" x-data="{ tokenType: 'random' }">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'regenerate-course-token','show' => false,'maxWidth' => '2xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'regenerate-course-token','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => '2xl']); ?>
        <form action="<?php echo e(route('courses.token.regenerate', $course)); ?>" method="POST" class="p-6" x-data="{ tokenType: 'random' }">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
    ...
    <?php $__currentLoopData = $course->classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'generate-class-token-'.e($class->id).'','show' => false,'maxWidth' => '2xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'generate-class-token-'.e($class->id).'','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => '2xl']); ?>
            <form action="<?php echo e(route('course-periods.token.generate', [$course, $class])); ?>" method="POST" class="p-6" x-data="{ tokenType: 'random' }">
                <?php echo csrf_field(); ?>
                <h2 class="text-lg font-bold text-gray-900 mb-2">Generate Token Kelas</h2>
                <p class="text-sm text-gray-600 mb-4"><?php echo e($class->name); ?></p>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'regenerate-class-token-'.e($class->id).'','show' => false,'maxWidth' => '2xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'regenerate-class-token-'.e($class->id).'','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => '2xl']); ?>
            <form action="<?php echo e(route('course-periods.token.regenerate', [$course, $class])); ?>" method="POST" class="p-6" x-data="{ tokenType: 'random' }">
                <?php echo csrf_field(); ?>
                <h2 class="text-lg font-bold text-gray-900 mb-2">Regenerate Token Kelas</h2>
                <p class="text-sm text-gray-600 mb-2"><?php echo e($class->name); ?></p>
                <div class="bg-yellow-50 border-l-4 border-yellow-400 p-3 mb-4">
                    <p class="text-sm text-yellow-700">⚠️ Token lama akan tidak valid setelah regenerate</p>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\PC2\Videos\IT\Code\LMSCOK\ABC\Cok\LMSAPP_Laravel_V2\resources\views/courses/tokens.blade.php ENDPATH**/ ?>