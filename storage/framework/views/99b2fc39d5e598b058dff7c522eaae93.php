...
<?php $component->withAttributes([]); ?>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
                ...
                <div class="xl:col-span-4 space-y-6">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="group">
                                    ...
                                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 rounded-2xl p-4 group-hover:shadow-md transition-all duration-300">
                                        <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($certificate->user->name); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="group">
                                    ...
                                    <div class="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-700 dark:to-gray-600 rounded-2xl p-4 group-hover:shadow-md transition-all duration-300">
                                        <p class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($certificate->course->title); ?></p>
                                    </div>
                                </div>
                                ...
                                <!-- Date & ID Grid -->
                                    <div class="group">
                                        ...
                                        <div class="bg-gradient-to-r from-orange-50 to-red-50 dark:from-gray-700 dark:to-gray-600 rounded-2xl p-4 group-hover:shadow-md transition-all duration-300">
                                            <p class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($certificate->issued_at->format('d M Y')); ?></p>
                                        </div>
                                    </div>
                                    <div class="group">
                                        ...
                                        <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-gray-700 dark:to-gray-600 rounded-2xl p-4 group-hover:shadow-md transition-all duration-300">
                                            <p class="text-xs font-mono font-bold text-gray-900 dark:text-white break-all"><?php echo e(($certificate->certificate_code)); ?></p>
                                        </div>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <div class="space-y-3">
                            <a href="<?php echo e(Storage::url('certificates/' . $certificate->certificate_code . '.pdf')); ?>" 
                               download 
    ...
    <script>
        ...
        const pdfUrl = "<?php echo e(Storage::url('certificates/' . $certificate->certificate_code . '.pdf')); ?>";
        ...
        function openInNewTab() {
            window.open("<?php echo e(Storage::url('certificates/' . $certificate->certificate_code . '.pdf')); ?>", '_blank');
        }
...
<?php endif; ?><?php /**PATH C:\Users\PC2\Videos\IT\Code\LMSCOK\ABC\Cok\LMSAPP_Laravel_V2\resources\views/certificates/show.blade.php ENDPATH**/ ?>