...
<?php $component->withAttributes([]); ?>
                ...
                <div class="max-w-7xl mx-auto">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold text-white"><?php echo e($quiz->title); ?></h1>
                                <p class="text-blue-100 text-sm">
                                    <?php if($quiz->lesson && $quiz->lesson->course): ?>
                                        <?php echo e($quiz->lesson->course->title); ?>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/20">
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-white"><?php echo e($quiz->questions->count()); ?></div>
                                    <div class="text-xs text-blue-200">Soal</div>
                                </div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/20">
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-white"><?php echo e($quiz->pass_marks); ?></div>
    ...
    <div class="py-8 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex gap-6">
                    ...
                    <div class="sticky top-24">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-gray-200">
                            ...
                            <div class="mb-4">
                                <div class="flex items-center justify-between mb-2">
                                    <span id="progress-text" class="text-sm font-semibold text-gray-700">0 / <?php echo e($quiz->questions->count()); ?></span>
                            ...
                            <div class="mt-4 p-3 bg-indigo-50 rounded-lg border border-indigo-200">
                                <div class="text-sm text-indigo-700">
                                    ...
                                    <span class="text-gray-600">/ <?php echo e($quiz->questions->count()); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-200">
                            ...
                            <div class="grid grid-cols-5 gap-2">
                                <?php for($i = 1; $i <= $quiz->questions->count(); $i++): ?>
                                    <button onclick="goToQuestion(<?php echo e($i - 1); ?>)"
                                            ...
                                            data-question="<?php echo e($i - 1); ?>"
                                            title="Soal <?php echo e($i); ?>">
                                        <?php echo e($i); ?>
                ...
                <div class="flex-1">
                    <form id="quiz-attempt-form" method="POST" action="<?php echo e(route('quizzes.submit_attempt', [$quiz, $attempt])); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div id="question-container">
                            <?php $__currentLoopData = $quiz->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="question-slide <?php echo e($index === 0 ? 'active' : 'hidden'); ?>"
                                     data-question-index="<?php echo e($index); ?>"
                                     id="question-slide-<?php echo e($index); ?>">
                                    ...
                                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                                                ...
                                                <div class="flex items-center space-x-4">
                                                    ...
                                                    <div>
                                                        <span class="text-lg font-semibold text-gray-800">
                                                            Soal <?php echo e($index + 1); ?> dari <?php echo e($quiz->questions->count()); ?>
                                                        ...
                                                        <div class="flex items-center space-x-3 mt-1">
                                                            ...
                                                            <span class="text-sm text-indigo-600 font-medium">
                                                                <i class="fas fa-star mr-1"></i><?php echo e($question->marks); ?> poin
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="p-8 bg-white min-h-[400px]">
                                            ...
                                            <?php if($question->type === 'multiple_choice'): ?>
                                                <div class="space-y-4">
                                                    <?php $__currentLoopData = $question->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionIndex => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <label class="option-item group block relative cursor-pointer">
                                                            <input type="radio"
                                                                   name="answers[<?php echo e($index); ?>][option_id]"
                                                                   value="<?php echo e($option->id); ?>"
                                                                   class="sr-only peer"
                                                                   onchange="updateProgress(); autoSave(); updateQuestionStatus(<?php echo e($index); ?>);">
                                                ...
                                                <input type="hidden" name="answers[<?php echo e($index); ?>][question_id]" value="<?php echo e($question->id); ?>">
                                            ...
                                            <?php elseif($question->type === 'true_false'): ?>
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    ...
                                                    <label class="option-item group block relative cursor-pointer">
                                                        <input type="radio"
                                                               name="answers[<?php echo e($index); ?>][answer_text]"
                                                               value="True"
                                                               class="sr-only peer"
                                                               onchange="updateProgress(); autoSave(); updateQuestionStatus(<?php echo e($index); ?>);">
                                        ...
                                        <div class="bg-gray-50 px-8 py-5 border-t border-gray-200">
                                            <div class="flex items-center justify-between">
                                                <button type="button"
                                                        ...
                                                        class="px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold rounded-lg transition-all duration-200 <?php echo e($index === 0 ? 'invisible' : ''); ?>"
                                                        id="prev-btn-<?php echo e($index); ?>">
                                                    <i class="fas fa-chevron-left mr-2"></i>
                                                    Sebelumnya
                                                </button>

                                                <div class="text-sm text-gray-600 font-medium">
                                                    Soal <span class="text-indigo-600 font-bold"><?php echo e($index + 1); ?></span> dari <?php echo e($quiz->questions->count()); ?>

                                                </div>

                                                <button type="button"
                                                        onclick="nextQuestion()"
                                                        class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition-all duration-200 <?php echo e($index === $quiz->questions->count() - 1 ? 'hidden' : ''); ?>"
                                                        id="next-btn-<?php echo e($index); ?>">
                                                    Selanjutnya
                                                ...
                                                <button type="button"
                                                        onclick="showSubmitConfirmation(event)"
                                                        class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-all duration-200 <?php echo e($index !== $quiz->questions->count() - 1 ? 'hidden' : ''); ?>"
                                                        id="submit-btn-<?php echo e($index); ?>">
                                                    <i class="fas fa-paper-plane mr-2"></i>
                                                    Kirim Jawaban
                                                </button>
                                            </div>
                ...
                <div class="bg-gray-50 rounded-xl p-4 mb-6">
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <br><span id="modal-answered-count" class="font-bold text-indigo-600">0 / <?php echo e($quiz->questions->count()); ?></span>
                        </div>
                        <div>
    ...
    <script>
        ...
        <?php if($quiz->time_limit && isset($timeRemaining) && $timeRemaining > 0): ?>
            let timeLeft = Math.floor(<?php echo e($timeRemaining); ?>);
            const totalTime = <?php echo e($quiz->time_limit); ?> * 60;
...
<?php endif; ?>
<?php /**PATH C:\Users\PC2\Videos\IT\Code\LMSCOK\ABC\Cok\LMSAPP_Laravel_V2\resources\views/quizzes/attempt.blade.php ENDPATH**/ ?>