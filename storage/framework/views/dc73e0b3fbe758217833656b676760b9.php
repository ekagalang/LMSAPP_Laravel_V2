                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex justify-between items-center mt-4">
                                            <div class="flex items-center gap-4">
                                                <a href="<?php echo e(route('courses.show', $course['id'])); ?>" class="text-green-600 hover:underline font-medium text-sm">
                                                    <?php echo e($course['status'] === 'not_started' ? 'Mulai Belajar' : 'Lanjutkan Belajar'); ?>

                                                </a>
                                                <a href="<?php echo e(route('courses.my-scores', $course['id'])); ?>" class="text-blue-600 hover:underline font-medium text-sm">
                                                    Nilai & Hasil
                                                </a>
                                            </div>
                                            ...
                                            <?php if($showCertificateButton): ?>
                                                ...
                                                <?php elseif($certificateButtonType === 'generate'): ?>
                                                    ...
                                                    <a href="<?php echo e(route('certificates.create', $courseModel)); ?>" 
