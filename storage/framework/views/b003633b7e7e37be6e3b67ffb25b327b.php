        ...
        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
            <div class="max-w-7xl mx-auto px-6 py-8">
                <div class="flex items-center justify-between">
                    ...
                    <?php if($quiz->enable_leaderboard): ?>
                        <a href="<?php echo e(route('quizzes.leaderboard', $quiz)); ?>"
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-4 border border-gray-100 hover:shadow-xl transition-shadow">
                            ...
                            <div class="mt-3">
                                <p class="text-2xl font-bold text-gray-900"><?php echo e($quiz->questions->count()); ?></p>
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-4 border border-gray-100 hover:shadow-xl transition-shadow">
                            ...
                            <div class="mt-3">
                                <p class="text-2xl font-bold text-gray-900"><?php echo e($quiz->total_marks); ?></p>
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-4 border border-gray-100 hover:shadow-xl transition-shadow">
                            ...
                            <div class="mt-3">
                                <p class="text-2xl font-bold text-gray-900"><?php echo e($quiz->passing_percentage); ?>%</p>
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-4 border border-gray-100 hover:shadow-xl transition-shadow">
                            ...
                            <div class="mt-3">
                                <?php if($quiz->time_limit): ?>
                                    <p class="text-2xl font-bold text-gray-900"><?php echo e($quiz->time_limit); ?></p>
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
                        ...
                        <form action="<?php echo e(route('quizzes.start_attempt', $quiz)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
                                ...
                                <span><?php echo e(__('Mulai Kerjakan Sekarang')); ?></span>
                            </button>
                        </form>
                                ...
                                <?php if($leaderboard->count() > 0): ?>
                                    <div class="space-y-3 max-h-[600px] overflow-y-auto custom-scrollbar pr-2">
                                        <?php $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <div class="flex items-center p-3 rounded-xl <?php echo e($isTop3 ? 'bg-white shadow-lg border-2 border-yellow-300' : 'bg-white shadow border border-gray-200'); ?> hover:scale-102 transition-transform">
                                                <!-- Rank Badge -->
                                                <div class="flex-shrink-0 mr-3">
                                                    <div class="w-10 h-10 <?php echo e($rankBg); ?> rounded-full flex items-center justify-center <?php echo e($isTop3 ? 'shadow-md' : ''); ?>">
                                                        <span class="font-bold <?php echo e($rankTextColor); ?>"><?php echo e($entry['rank']); ?></span>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="min-w-0 flex-1">
                                                            ...
                                                            <div class="text-xs text-gray-500">
                                                                <?php echo e($entry['score']); ?>/<?php echo e($entry['total_marks']); ?> poin
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex-shrink-0 text-right ml-3">
                                                    <div class="font-bold text-lg <?php echo e($entry['passed'] ? 'text-green-600' : 'text-red-600'); ?>">
                                                        <?php echo e(number_format($entry['percentage'], 0)); ?>%
                                                    </div>
                                                    <?php if($entry['rank'] <= 3): ?>
                                                        <div class="text-xs font-medium <?php echo e($entry['passed'] ? 'text-green-600' : 'text-red-600'); ?>">
                                                            <?php echo e($entry['passed'] ? '✓ Lulus' : '✗ Tidak Lulus'); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\PC2\Videos\IT\Code\LMSCOK\ABC\Cok\LMSAPP_Laravel_V2\resources\views/quizzes/start.blade.php ENDPATH**/ ?>