...
<?php $component->withAttributes([]); ?>
    ...
    <script>
        let allFiles = <?php echo json_encode($files, 15, 512) ?>;
        ...
        function deleteFile(path, name) {
            ...
            fetch('<?php echo e(route('file-control.delete')); ?>', {
                method: 'POST',
                headers: {
        ...
        async function handleFileSelect() {
            ...
            for (let i = 0; i < files.length; i++) {
                ...
                try {
                    ...
                    const response = await fetch('<?php echo e(route('file-control.upload')); ?>', {
                        method: 'POST',
                        body: formData
                    });
...
<?php endif; ?>
<?php /**PATH C:\Users\PC2\Videos\IT\Code\LMSCOK\ABC\Cok\LMSAPP_Laravel_V2\resources\views/file-control/index.blade.php ENDPATH**/ ?>