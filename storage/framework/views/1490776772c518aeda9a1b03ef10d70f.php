...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="font-bold text-2xl text-gray-900 leading-tight">
                    <?php echo e(__('Edit Kursus')); ?>

                </h2>
                <p class="text-sm text-gray-600 mt-1"><?php echo e($course->title); ?></p>
            </div>
            <div class="hidden md:flex items-center space-x-3">
                <div class="flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($course->status === 'published' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                    <?php echo e($course->status === 'published' ? '✅ Published' : '📝 Draft'); ?>
    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <a href="<?php echo e(route('courses.tokens', $course)); ?>" class="block mb-6">
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl">
                ...
                <div class="p-8" x-data="{
                    enablePeriods: <?php echo e($course->periods->count() > 0 ? 'true' : 'false'); ?>,
                    createDefaultPeriod: false,
                    customPeriods: <?php echo \Illuminate\Support\Js::from($course->periods->map(function($period) {
                        return [
                            'id' => $period->id,
                            'name' => $period->name,
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="group">
                                        ...
                                        <textarea name="description"
                                                  ...
                                                  placeholder="Jelaskan tentang kursus Anda, apa yang akan dipelajari siswa..."><?php echo e(old('description', $course->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="group">
                                        ...
                                        <textarea name="objectives"
                                                  ...
                                                  rows="3"
                                                  class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 group-hover:border-gray-400 resize-none"
                                                  placeholder="Setelah menyelesaikan kursus ini, peserta akan mampu..."><?php echo e(old('objectives', $course->objectives)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div x-data="{ imagePreview: '<?php echo e($course->thumbnail ? Storage::url($course->thumbnail) : ''); ?>' }" class="group">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="group">
                                        ...
                                        <select name="status"
                                                id="status"
                                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 group-hover:border-gray-400">
                                            <option value="draft" <?php echo e(old('status', $course->status) == 'draft' ? 'selected' : ''); ?>>
                                                📝 Draft
                                            </option>
                                            <option value="published" <?php echo e(old('status', $course->status) == 'published' ? 'selected' : ''); ?>>
                                                ✅ Published
                                            </option>
                                        </select>
                                        ...
                                        <select name="certificate_template_id" id="certificate_template_id"
                                            ...
                                            <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($template->id); ?>"
                                                        <?php if(old('certificate_template_id', $course->certificate_template_id ?? '') == $template->id): ?> selected <?php endif; ?>>
                                    ...
                                    <div class="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 rounded-lg p-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-3 text-center">
                                            <div class="bg-white rounded-lg p-2 shadow-sm">
                                                <div class="text-lg font-bold text-gray-800"><?php echo e($course->created_at->format('d M Y')); ?></div>
                                                <div class="text-xs text-gray-600">Dibuat</div>
                                            </div>
                                            <div class="bg-white rounded-lg p-2 shadow-sm">
                                                <div class="text-lg font-bold text-gray-800"><?php echo e($course->updated_at->format('d M Y')); ?></div>
...
<?php endif; ?>
<?php /**PATH C:\Users\PC2\Videos\IT\Code\LMSCOK\ABC\Cok\LMSAPP_Laravel_V2\resources\views/courses/edit.blade.php ENDPATH**/ ?>