...
<?php $component->withAttributes([]); ?>
    ...
    class="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
            ...
            <div class="fixed top-4 right-4 z-50 max-w-md" x-data="{ show: true }" x-show="show" x-transition>
                <div class="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-lg shadow-lg">
                    <div class="flex items-start">
                        ...
                        <p class="ml-3 text-sm text-amber-700"><?php echo e(session('warning')); ?></p>
        ...
        <main class="flex-1 flex flex-col min-h-screen lg:min-h-0">
                            ...
                            <div class="content-display">
                                ...
                                <?php elseif($content->type == 'document' && $content->file_path): ?>
                                    ...
                                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
                                        ...
                                        <?php if($content->documents && $content->documents->count()): ?>
                                            <div class="mb-6">
                                                <div class="bg-white rounded-xl border p-4">
                                                    <div class="flex items-center justify-between mb-3">
                                                        <p class="text-sm font-semibold text-gray-700">Lampiran Dokumen</p>
                                                        <a href="#" class="text-xs text-indigo-600 hover:underline js-doc-preview" data-url="<?php echo e($fileUrl); ?>" data-full-url="<?php echo e($fullFileUrl); ?>" data-ext="<?php echo e($fileExtension); ?>">Tampilkan file utama</a>
                                                    </div>
                                                    <ul class="space-y-2 text-sm">
                                                        <?php $__currentLoopData = $content->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($doc->file_path === $content->file_path) continue; ?>
                                                            <?php
                                                            ...
                                                            <li class="flex items-center justify-between">
                                                                <div class="flex items-center gap-3 min-w-0">
                                                                    ...
                                                                    <span class="truncate" title="<?php echo e($docName); ?>"><?php echo e($docName); ?></span>
                                                                </div>
                                                                <div class="flex items-center gap-3 flex-shrink-0">
                                                                    <?php if($accessType === 'download_only'): ?>
                                                                        <a href="<?php echo e($docUrl); ?>" download class="text-green-600 hover:underline">Unduh</a>
                                                                    <?php elseif($accessType === 'preview_only'): ?>
                                                                        <?php if($docExt === 'pdf'): ?>
                                                                            <?php if($fileExtension === 'pdf'): ?>
                                                                                <a href="#" class="text-indigo-600 hover:underline js-doc-preview" data-url="<?php echo e($docUrl); ?>" data-full-url="<?php echo e($docFullUrl); ?>" data-ext="<?php echo e($docExt); ?>">Preview</a>
                                                                            <?php else: ?>
                                                                                <a href="#" class="text-indigo-600 hover:underline js-doc-preview" data-url="<?php echo e($docUrl); ?>" data-full-url="<?php echo e($docFullUrl); ?>" data-ext="<?php echo e($docExt); ?>">Preview</a>
                                                                            <?php endif; ?>
                                                                        <?php else: ?>
            ...
            <?php if($fileExtension === 'pdf'): ?>
                window.loadDocumentPdf("<?php echo e($fileUrl); ?>");
            <?php else: ?>
                window.loadDocumentEmbed("https://docs.google.com/viewer?url=<?php echo e(urlencode($fullFileUrl)); ?>&embedded=true");
            <?php endif; ?>
